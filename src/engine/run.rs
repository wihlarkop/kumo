...
impl CrawlEngine {
        ...
        S: Spider + 'static,
    {
            ...
            tokio::spawn(async move {
                loop {
                    ...
                    tracing::info!(
                        ...
                        store_failed_writes = s.store.failed_writes,
        ...
        info!(
            ...
            store_failed_writes = stats.store.failed_writes,
            store_failed_batches = stats.store.failed_batches,
            store_queue_full_waits = stats.store.queue_full_waits,
            store_queue_wait_avg_secs = stats.store.average_queue_wait_per_item().as_secs_f64(),
            store_write_avg_batch_secs = stats.store.average_write_per_batch().as_secs_f64(),
        ...
        let report = crate::stats::CrawlReport::from(stats.clone());
        #[cfg(feature = "otel")]
        crate::otel::record_crawl_report(spider.name(), None, &report);
